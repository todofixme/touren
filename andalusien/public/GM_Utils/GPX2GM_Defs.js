...
console.info("GPX2GM_Defs vom 9. 9. 2025");
...
JB.GPX2GM.setparameters = function() {  
	...
	JB.GPX2GM.parameters.autoload = true;
	JB.GPX2GM.parameters.mapapi = (typeof(Mapapi)!="undefined") ? Mapapi : "osm";   // gm oder osm
	JB.GPX2GM.parameters.maptype = (typeof(Maptype)!="undefined") ? Maptype : ""; 
	JB.GPX2GM.parameters.overlay = (typeof(Overlay)!="undefined") ? Overlay : ""; 
	JB.GPX2GM.parameters.defaultmaptype = (typeof(Defaultmaptype)!="undefined") ? Defaultmaptype : "OSMDE";
	JB.GPX2GM.parameters.show_ign = (typeof(Show_ign)!="undefined") ? Show_ign : false; 
